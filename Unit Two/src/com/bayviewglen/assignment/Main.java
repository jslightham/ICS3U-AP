...
public class Main {
	 ...
	 * Date: 10/10/18
	 * Description: Track running times of 3 splits for 5 runners, 
	 * display runner summaries and data in a table.
	 */
	...
	public static void printSummary(double splitOne, double splitTwo, double splitThree, String runnerNumber, String runnerFirstName, String runnerLastName) {
		...
		System.out.println("******************\n");
		System.out.printf("%-15s%s\n", "Runner Name:", runnerLastName.substring(1) + ", " + runnerFirstName);
		
		// Using printf to add 0s into correct places, and shrink decimals
		System.out.printf("%-15s%d:%06.3f\n", "Split One:", getMinutes(splitOne), getSeconds(splitOne));
		System.out.printf("%-15s%d:%06.3f\n", "Split Two:", getMinutes(splitTwo - splitOne), getSeconds(splitTwo - splitOne));
		System.out.printf("%-15s%d:%06.3f\n", "Split Three:", getMinutes(splitThree - splitTwo), getSeconds(splitThree - splitTwo));
		System.out.printf("%-15s%d:%06.3f\n", "Total: ", getMinutes(splitThree), getSeconds(splitThree));
